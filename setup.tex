...
\newcommand{\app}{\,} % space for function application juxtaposition, e.g. f\app a\app b
...
\newcommand{\iexp}[1]{\app\text{\ttfamily #1}\app} % Isabelle-style expression, e.g. a \iexp{+} b. Escape underscores manually, e.g. \iexp{add\_spec}
\usepackage{siunitx}
\usepackage{hyperref}
