...
\lstnewenvironment{isabellecode}[1][]{%
  \lstset{style=isabellestyle,#1}%
  \minipage{\linewidth}%
}{%
  \endminipage%
}
\newcommand{\isabellecodeextern}[2][]{\lstinputlisting[style=isabellestyle,#1]{#2}}
